...
/// Unified duck-cli connection screen
/// Prefers local on-phone duck-cli, with LAN/Tailscale/manual fallbacks.
...
class _ConnectGatewayScreenState extends State<ConnectGatewayScreen>
      ...
      builder: (context) => AlertDialog(
        title: Row(
          children: [
            ...
            const Text('Connect to duck-cli?'),
          ],
        ),
        content: Column(
          mainAxisSize: MainAxisSize.min,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Connect to duck-cli'),
        actions: [
          IconButton(
